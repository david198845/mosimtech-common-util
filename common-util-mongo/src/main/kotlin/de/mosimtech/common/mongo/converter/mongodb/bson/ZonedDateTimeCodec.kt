package de.mosimtech.common.mongo.converter.mongodb.bson
...
open class ZonedDateTimeCodec : Codec<ZonedDateTime> {
    ...
    /**
     * Returns the `Class` object associated with the `ZonedDateTime` notificationType that this codec encodes and decodes.
     *
     * @return the `Class` instance representing the `ZonedDateTime` notificationType
     */
