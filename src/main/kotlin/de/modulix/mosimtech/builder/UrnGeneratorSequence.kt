 ...
 * based on the specified `Namespace` and optional namespace identifiers (`snid`).
 *
 * @property namespace Specifies the `Namespace` class used to define the context or scope for the URN generation.
 * @property snid Optional array of strings representing specific namespace identifiers. These identifiers help in further
...
annotation class UrnGeneratorSequence(val namespace: String, vararg val snid: String = []) {
}